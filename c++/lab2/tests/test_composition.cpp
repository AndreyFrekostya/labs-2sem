...
int main() {
    const char* filename = "public/test_composition.txt";
    ...
    if (ok) {
        std::cout << "Тест композиции пройден\n";
    } else {
        std::cout << "Тест композиции не пройден\n";
    }
