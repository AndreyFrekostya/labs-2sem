...
int main() {
    const char* filename = "public/test_rle_2.txt";
    ...
    {
        RleFile2 file(new BaseFile(filename, "wb"));
        int pos = 0;
    ...
    {
        RleFile2 file(new BaseFile(filename, "rb"));
        int pos = 0;
    ...
    if (ok) {
        std::cout << "Тест RleFile2 пройден\n";
    } else {
        std::cout << "Тест RleFile2 не пройден\n";
    }
