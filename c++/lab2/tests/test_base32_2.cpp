...
int main() {
    const char* filename = "public/test_base32_2.txt";
    ...
    {
        Base32File2 file(new BaseFile(filename, "wb"));
        int pos = 0;
    ...
    {
        Base32File2 file(new BaseFile(filename, "rb"));
        int pos = 0;
    ...
    if (ok) {
        std::cout << "Тест Base32File2 пройден\n";
    } else {
        std::cout << "Тест Base32File2 не пройден\n";
    }
