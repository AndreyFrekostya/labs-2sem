...
int main() {
    ...
    */
    ...
    //     //б) b32_files указывает на массив Base32File, но тип на самом деле BaseFile*, 
    //     //и когда вызывается b32_files[i].write("Hello!", 6); b32_files[i] это объект типа BaseFile, а не Base32File.
    //     //Из объекта производного класса создаётся объект базового класса, 
    //     //и вся информация, специфичная для производного, теряется.
    // } 
